    ...
    <div class="mr-[20px]" :style="`margin-left:${leftSideBarWidth}`">
        ...
        <div class="xl:flex">
            <div class="xl:w-1/2 h-full ">
                            ...
                            <div class="py-2">
                                <div>
                                    ...
                                    <div class="flex items-center pt-4">
                                        <input class="pl-[1rem] py-3 rounded-md border-[2px]" type="text"
                                            value="123,123,123" />
                                        <button @click="routeToEnergyManagementVue"
                                            class="bg-primary text-white w-[80px] px-2 py-2 rounded-md relative right-[90px] whitespace-nowrap">상세보기</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                border-gray-200 px-[20px] cursor-pointer rounded-[16px] hover:bg-gray-200 py-3 px-3 ">
                        ...
                        <div class="flex ml-auto items-center mt-3">
                            ...
                            <div class="bg-[#E7F8F3] text-black text-[0.8rem] font-bold rounded-[16px] px-3 py-1">
                                2등급
                            </div>
                        </div>
            ...
            border-gray-200 px-[20px] cursor-pointer rounded-[16px] hover:bg-gray-200 py-3 px-3 ">
                    ...
                    <div class="flex justify-center text-[0.8rem] shadow-lg h-full">
