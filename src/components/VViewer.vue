<template>
    ...
    <div class="btn">
        ...
        <div>
            <a aria-label="martinageradams" title="GitHub"
        ...
        <div>
            <a aria-label="martinageradams" title="Gitee"
                href="https://martinageradams.gitee.io/vue-cesium-vite-app"><svg height="20" version="1.1" width="35"
                    aria-hidden="true">
...
Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIyZDczNDlkYi0yNTMxLTQzNDAtOGU3Ny1lNDIxMGRkZmYzY2YiLCJpZCI6OTI5MjUsImlhdCI6MTY1MjA3MTExOX0.Twp4GgSqNbcLHz-LH8QTIG7vMKz-GaWIjNSyW49KO4A'
